...
// Bump this version string when you push a new catalyst_app.html so clients pull fresh code.
const CACHE = 'catalyst-v1';
const FILES = ['./catalyst_app.html'];
    ...
    caches.match(e.request).then(cached => {
      ...
      if (e.request.destination === 'document' || url.pathname.endsWith('.html')) {
        return fetch(e.request)
          ...
          .catch(() => cached || caches.match('./catalyst_app.html'));
      }
